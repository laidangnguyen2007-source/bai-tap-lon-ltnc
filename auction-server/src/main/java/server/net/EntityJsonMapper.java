...
import server.model.entity.item.Artwork;
import server.model.entity.item.Electronics;
import server.model.entity.item.Item;
import server.model.entity.item.Vehicle;
...
public final class EntityJsonMapper {
  ...
  public JSONObject auctionToJSON(Auction auction) {
    ...
    json.put("itemSpecifics", itemOpt.map(Item::getItemSpecifics).orElse(""));
  ...
  public JSONObject itemToJSON(Item item) {
    ...
    json.put("itemSpecifics", item.getItemSpecifics());
