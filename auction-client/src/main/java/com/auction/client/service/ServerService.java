...
public class ServerService {
  ...
  private void handlePushMessage(String line) {
    try {
      ...
      } else if ("FUNDS_LOCKED".equals(type)
          || "FUNDS_RELEASED".equals(type)
          || "OUTBID".equals(type)
          || "OUTBID_NOTIFICATION".equals(type)
          || "AUCTION_WON".equals(type)
          || "AUCTION_LOST".equals(type)
  ...
  public boolean updateAuctionSeller(
      ...
      String imageBase64,
      long minBidStep) {
    return auctionHandler.updateAuctionSeller(
        auctionId,
        sellerId,
        itemName,
        category,
  ...
  public boolean adminAdjustBalance(
      Long userId, long amount, Long adminId, String role, String desc) {
